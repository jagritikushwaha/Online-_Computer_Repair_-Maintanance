...
?>
<div class="col-sm-9 col-md-10" style="color:white; margin-top:85px;">
  <?php 
 ...
 if($result->num_rows > 0){
    ...
    {
    echo '<tr style="color:white; margin-top:40px;">';
   ...
   echo '<td>';
   echo '<form action="viewassignwork.php"
    method="POST" class="d-inline">'; 
    echo '<input type="hidden" name="id" value='. $row["request_id"] .'><button  class="btn btn-warning" name="view" value="View"
     type="submit"><i class="far fa-eye"></i></button>';
    echo '</form>';
    echo '<form action=""
    method="POST" class="d-inline">'; 
    echo '<input type="hidden" name="id" value='. $row["request_id"] .'><button  class="btn btn-secondary" name="delete" value="Delete"
