      ...
      label{
          ...
          margin-top:10px;
           ...
           input#submit{
               ...
               border:none;
               border-radius: 3px;
               background-color:rgba(194, 55, 55, 0.877);
               color: #fff;
               cursor:pointer;
               border:1px solid
...
<body bg-color="green">
  <div class=" mt-5 text-center " style="font-size: 30px; margin-top:60px; color:white; text-align:center">   
    ...
    <span >Online Computer Repair Maintenance </span>
  </div>
    <p class="text-center" style="font-size: 20px; color:white; text-align:center "> <i class="fas fa-user-secret "></i> <span>Requester
      Area(Demo)</span>
    </p>
    ...
    <div class="col-sm-6 col-md-4">
         ...
         <div class="btn" style="margin-top:4px; text-align:center;"><a  href="new.php"><b>Back
            to Home</b></a></div>
...
if(!isset($_SESSIION['is_login'])){
  if(isset($_REQUEST['rEmail'])){
    $rEmail = mysqli_real_escape_string($conn,trim($_REQUEST['rEmail']));
    $rPassword = mysqli_real_escape_string($conn,trim($_REQUEST['rPassword']));
    $sql = "SELECT r_email, r_password FROM userlogin_tb WHERE r_email='".$rEmail."' AND r_password='".$rPassword."' limit 1";
