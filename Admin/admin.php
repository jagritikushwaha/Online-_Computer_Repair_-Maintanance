...
<body>
  <div class=" mt-5 text-center " style="font-size: 30px; margin-top:60px;color:white; text-align:center">   
    ...
    <p class="text-center" style="font-size: 20px;color:white; text-align:center "> <i class="fas fa-user-secret "></i> <span>Admain
      Area(Demo)</span>
    </p>
    ...
    <div class="col-sm-6 col-md-4">
         ...
         <form style="margin-top:20px; margin-left: 20px; padding:30px">
         ...
         <div class="btn" style="margin-top:2px; text-align:center;"><a  href="../new.php"><b>Back
            to Home</b></a></div>
